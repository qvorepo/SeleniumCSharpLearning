...
namespace SeleniumPractice
{
    public static class Reporter
    {
        ...
        private static string ApplicationDebuggingFolder => "c://temp/Selenium_ExtentReports";
        ...
        private static void CreateReportDirectory()
        {
            ...
            LatestResultsReportFolder = Path.Combine(filePath, DateTime.Now.ToString("yyyyMMdd_HHmm"));
            //Directory.CreateDirectory(LatestResultsReportFolder);

            //HtmlReportFullPath = $"{LatestResultsReportFolder}//TestResults.html";
            HtmlReportFullPath = $"{LatestResultsReportFolder}_TestResults.html";
