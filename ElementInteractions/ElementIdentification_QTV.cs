...
namespace ElementInteractions
{
    ...
    public class ElementIdentification_QTV
    {
        ...
        [TestMethod]
        [TestCategory("Element Interrogation")]
        public void ElementInterrogationTest_QTV()
        {
            ...
            Assert.AreEqual(190, element.Location.X);
            Assert.AreEqual(330, element.Location.Y);
        }
