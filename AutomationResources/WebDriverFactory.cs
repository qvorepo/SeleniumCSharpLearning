...
namespace AutomationResources
{
    public class WebDriverFactory
    {
        ...
        private IWebDriver GetChromeDriver()
        {
            ...
            //Chrome options are for file download
            var options = new ChromeOptions();
            options.AddUserProfilePreference("download.default_directory", @"C:\Users\Mamga\Downloads");
            options.AddUserProfilePreference("download.prompt_for_download", false);
            options.AddUserProfilePreference("download.directory_upgrade", true);
            options.AddUserProfilePreference("safebrowsing.enabled", true);//Disable message 'This type of file can harm...' on file download.
